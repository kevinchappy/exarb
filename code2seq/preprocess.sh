...
TRAIN_DIR=/home/kev/test/code2seq/data/java-large-if-statement/training
VAL_DIR=/home/kev/test/code2seq/data/java-large-if-statement/validation
TEST_DIR=/home/kev/test/code2seq/data/java-large-if-statement/test
...
EXTRACTOR_JAR=/home/kev/test/code2seq/JavaExtractor/JPredict/target/JavaExtractor-0.0.1-SNAPSHOT.jar
